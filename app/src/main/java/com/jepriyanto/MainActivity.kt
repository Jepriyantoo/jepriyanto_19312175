...
import com.jepriyanto.ui.theme.JepriyantoTheme
...
fun Promotions() {
    LazyRow(
        ...
        item {
            PromotionItem(
                imagePainter = painterResource(id = R.drawable.speakearkayu),
                title = "Speker Kayu",
                subtitle = "Start @",
                header = "$1000",
        ...
        item {
            PromotionItem(
                imagePainter = painterResource(id = R.drawable.speakerbulat),
                title = "Speker Bulat",
                subtitle = "Discount",
                header = "20%",
...
fun CategorySection() {
    Column(Modifier.padding(horizontal = 16.dp)) {
        ...
        Row(
            ...
            CategoryButton(
                text = "Speaker",
                icon = painterResource(id = R.drawable.speaker),
                backgroundColor = Color(0xffFEF4E7)
            )
            CategoryButton(
                text = "Speaker Gaming ",
                icon = painterResource(id = R.drawable.speakergaming),
                backgroundColor = Color(0xffF6FBF3)
            )
            CategoryButton(
                text = "Speaker Gaming kayu",
                icon = painterResource(id = R.drawable.speakergamingkayu),
                backgroundColor = Color(0xffFFFBF3)
            )
            CategoryButton(
                text = "Speaker Modern",
                icon = painterResource(id = R.drawable.speakermodern),
...
fun BestSellerItems() {
    LazyRow(
        ...
        item {
            BestSellerItem(
                imagePainter = painterResource(id = R.drawable.speakertabung),
                title = "Speaker Tabung",
                price = "1.99",
                discountPercent = 10
            )
        }
